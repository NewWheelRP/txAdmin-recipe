CREATE TABLE IF NOT EXISTS `characters` (
    ...
    `nationality` varchar(50) NOT NULL COLLATE 'utf8mb4_general_ci',
    `backstory`   text                 COLLATE 'utf8mb4_general_ci',
    `coords`      text,
...
CREATE TABLE IF NOT EXISTS `players` (
    ...
    `groups`     varchar(50) NOT NULL DEFAULT 'user' COLLATE 'utf8mb4_general_ci',
...
) COLLATE='utf8mb4_general_ci' ENGINE=InnoDB AUTO_INCREMENT=20;
